(function ($) {
    ...
    /** Mouse Cursor **/
    function Vanguard42MouseCursor(init) {
    ...
    function Vanguard42DynamicList() {

        let list = $('.Vanguard42-dynamic-list');
        ...
        list.each(function () {
            ...
            item.each(function () {
                ...
                animation ? new Vanguard42TextAnimation($this.find('a')) : '';
    ...
    function siteNavigation() {
        ...
        function classicNavigation() {
            ...
            if (nav.hasClass('one-page')) {
                ...
                nav.children('ul').children('li').each(function () {
                    ...
                    $this.find('a').addClass('Vanguard42-scroll-button');
            ...
            let hasChild = nav.find('.main-menu').children('.Vanguard42-has-children');
            ...
            setTimeout(function () {
                ...
                hasChild.each(function (i) {
                    ...
                    $this.find('.Vanguard42-sub-menu-wrap').addClass('sub_' + i).insertBefore(siteHeader)
        ...
        function menuToggle(targetMenu) {
            ...
            setTimeout(function () {
                ...
                let navTweens = gsap.getTweensOf(targetMenu.find('*').not('.main-menu *, .Vanguard42-button, .Vanguard42-button *')),
                    i = 0,
                    tltl = gsap.timeline({
                        id: 'fs_menu_tl'
                    });
    ...
    class Vanguard42GeneralAnimations {
    ...
    function Vanguard42GeneralAnims(target) {

        target.each(function () {

            let $this = $(this);

            new Vanguard42GeneralAnimations($this)
    ...
    function Vanguard42ParallaxImages() {
    ...
    class Vanguard42ImageAnimation {
    ...
    function Vanguard42ImageAnims() {

        $('.has-anim-image').each(function () {


            let $this = $(this);
            new Vanguard42ImageAnimation($this);
    ...
    function Vanguard42TextAnims() {
        ...
        hasAnim.not(exclude).each(function () {
            ...
            let textAnim = new Vanguard42TextAnimation($this);
            ...
            matchMedia.add({
                ...
                if (textAnim.progress == 0) {
                    ...
                    new Vanguard42TextAnimation($this);
    ...
    function Vanguard42ListAnimations() {
        ...
        list.each(function () {
            ...
            if (animation) {
                ...
                listItem.each(function () {
                    ...
                    let anim = new Vanguard42TextAnimation($this);
    ...
    function Vanguard42TextWrapper() {
    ...
    function Vanguard42SinglePostPage() {
    ...
    function Vanguard42ProductPage() {
    ...
    function Vanguard42ProjectPages() {
        ...
        let nextProj = $('.Vanguard42-next-project'),
    ...
    function Vanguard42ShopPage() {

        let products = $('.Vanguard42-products-grid');
    ...
    function showcaseFullscreenCarousel() {
        ...
        showcaseFullscreenCarousel.each(function (i) {
            ...
            imagesWrap.find('.Vanguard42-video').each(function () {

                Vanguard42Video($(this))
    ...
    function showcaseInfiniteGrid() {
        ...
        fullscreenGrid.each(function (i) {
            ...
            lenis.on('scroll', (e) => {
                var bgMarquee = gsap.getById('Vanguard42_marquee'),
    ...
    function layoutSwitcher() {
        ...
        let switcher = $('.Vanguard42-layout-switcher'),
    ...
    function postsGrid() {
        ...
        var grid = $('.Vanguard42-posts-grid');
    ...
    function Vanguard42CartButton() {

        var button = $('.Vanguard42-cart-button');
    ...
    function Vanguard42ProductRatings() {
    ...
    Vanguard42ProductRatings()

    function Vanguard42AddTocartButton() {
    ...
    Vanguard42AddTocartButton()


     function Vanguard42LightboxGallery(gallery, items) {
                ...
                const $lightbox = $('<div>', {
                        class: 'Vanguard42-lightbox-hold',
                        html: `
                ...
                function createNav(range, length, index) {
                    ...
                    //NavbyWheel
                    thumbsWheeler = Hamster(document.querySelector('.Vanguard42-lightbox-hold'));
                    var xVal = currX;
    ...
    function Vanguard42DynamicGrid() {

        const grid = $('.Vanguard42-dynamic-grid');
        ...
        grid.each(function () {
            ...
            grid.hasClass('lightbox-gallery') ? Vanguard42LightboxGallery(wrapper, items) : '';
            ...
            items.each(function (i) {
                ...
                if (animation != null) {
                    ...
                    grid.hasClass('image-grid') ? new Vanguard42ImageAnimation($this) : new Vanguard42GeneralAnimations($this);
    ...
    function Vanguard42FilterableGrid() {

        let $scope = $('.Vanguard42-filterable-grid'),
    ...
    function Vanguard42Forms() {

        let form = $('.Vanguard42-form');
    ...
    function Vanguard42SingleProject() {
    ...
    function Vanguard42DynamicCarousel() {
        const carousel = $('.Vanguard42-dynamic-carousel');
        ...
        carousel.each(function () {
            ...
            items.each(function (i) {
                ...
                if (animation != null) {
                    ...
                    carousel.hasClass('image-carousel') ? new Vanguard42ImageAnimation($this) : new Vanguard42GeneralAnimations($this);
    ...
    function Vanguard42Icons() {

        $('.Vanguard42-icon').each(function () {
    ...
    function Vanguard42ImageCompare() {
    ...
    function Vanguard42Video(vid) {
        ...
        if ((video.length) && (!video.hasClass('vid-ready'))) {
            ...
            video.each(function (i) {
                ...
                const Vanguard42Vid = new Plyr(video, {
                    controls: controls,
                    clickToPlay: true,
                    autopause: false,
                    debug: false,
                ...
                if (!$this.hasClass('n-self')) {
                    Vanguard42Vid.autoplay = nautoplay
                    Vanguard42Vid.muted = nmuted
                    Vanguard42Vid.loop = nloop
                }



                Vanguard42Vid.on('ready', (event) => {
                    ...
                    $this.find('.plyr').addClass('Vanguard42_video_' + i);
                    $this.addClass('Vanguard42-fake-running');

                    let vid = $('.Vanguard42_video_' + i);



                    vid.find('.plyr__video-wrapper').addClass('Vanguard42-video-wrap');
                    vid.find('.plyr__controls').addClass('Vanguard42-controls-wrap');

                    vid.find('.plyr__control[data-plyr="play"]').append('<span class="hover-default Vanguard42-player-control Vanguard42-play">' + playText + '</span><span class="hover-default Vanguard42-player-control Vanguard42-pause">' + pauseText + '</span>')

                    vid.find('.plyr__controls__item.plyr__volume button[data-plyr="mute"]').append('<span class="hover-default Vanguard42-player-control Vanguard42-mute">' + muteText + '</span><span class="hover-default Vanguard42-player-control Vanguard42-unmute">' + unmuteText + '</span>');

                    if ($this.hasClass('play-inner')) {

                        $this.find('.Vanguard42-play-button').on('click', function () {
                            ...
                            if ($this.hasClass('lightbox-play')) {
                                ...
                                Vanguard42Vid.muted = false;
                                Vanguard42Vid.restart();
                                Vanguard42Vid.play();
                                $this.addClass('Vanguard42-running');
                                $this.removeClass('Vanguard42-fake-running');
                    ...
                    if ($this.hasClass('play-cursor')) {
                        ...
                        $this.on('click', function () {
                            ...
                            if ($this.hasClass('lightbox-play')) {
                                ...
                                if ($this.hasClass('Vanguard42-fake-running')) {
                                    $this.removeClass('cursor-icon');
                                    $this.removeClass('cursor-text');
                        ...
                        $this.on('mouseenter', function () {
                            if ($this.hasClass('Vanguard42-running')) {
                    ...
                    function lightboxPlay() {
                        ...
                        Vanguard42Vid.fullscreen = false
                        ...
                        if ($this.hasClass('ratio-adjusted')) {
                            ...
                            let $iframe = $('.nlv').find('.Vanguard42-video-wrap');
                        ...
                        $('.lightbox-close').on('click', function () {
                            ...
                            gsap.to('.nlv', {
                                ...
                                onComplete: () => {
                                    ...
                                    vid.find('.plyr__video-wrapper').removeClass('Vanguard42-video-wrap');
                                    vid.find('.plyr__controls').removeClass('Vanguard42-controls-wrap');

                                    Vanguard42Vid.muted = true;

                                    vid.prependTo($this);

                                    $this.removeClass('Vanguard42-running');
                                    $this.addClass('Vanguard42-fake-running');
                            ...
                            if ($this.hasClass('ratio-adjusted')) {
                                ...
                                $this.attr('ratio', Vanguard42Vid.ratio);

                                let rat = Vanguard42Vid.ratio.split(':')[0] / Vanguard42Vid.ratio.split(':')[1],
                                ...
                                if (parentRatio < rat) {
                                    ...
                                    function adjustIframeSize() {
                                        ...
                                        const $iframe = $this.find('.Vanguard42-video-wrap');
                    ...
                    if (Vanguard42Vid.autoplay == true) {
                ...
                if ($this.parents('.has-anim').length && $this.parents('.project-page').length) {
                    ...
                    setTimeout(function () {
                        ...
                        Vanguard42Vid.once('playing', (event) => {
                            anim[0].parent.play();
    ...
    function Vanguard42Heading() {


        let heading = $('.Vanguard42-heading');
    ...
    function Vanguard42CircleText() {

        let circularText = $(".Vanguard42-circular-text");
    ...
    function Vanguard42Buttons() {

        var button = $('.Vanguard42-button');
        ...
        button.each(function () {
            ...
            if (animation) {
                ...
                new Vanguard42TextAnimation($this.find('.button-anim-holder'))
    ...
    function Vanguard42Marquee(i) {

        var velocity;
        let marquee = $('.Vanguard42-marquee');
        ...
        marquee.each(function () {
            ...
            window.onresize = function () {
                $this.find('.Vanguard42-marquee:first-child').nextAll().remove()
    ...
    function Vanguard42Services() {
        let Vanguard42Services = $('.Vanguard42-services');

        Vanguard42Services.each(function () {

            let services = $(this),
                servicesItem = services.find('.Vanguard42-service');

            servicesItem.append("<span class='services-item-bottom-line Vanguard42-service-line'></span>")
    ...
    function Vanguard42Accordion() {
        let Vanguard42Accordion = $('.Vanguard42-accordion');

        Vanguard42Accordion.each(function () {
            let $this = $(this),
            ...
            if (animation) {
                ...
                new Vanguard42TextAnimation(acrdTitle.children('span'))
            }
    ...
    function Vanguard42ClinetsCarousel() {

        let clientCarousel = $('.Vanguard42-clients-carousel');
    ...
    function Vanguard42InfiniteCarousel() {

        let clientCarousel = $('.Vanguard42-infinite-carousel');
    ...
    function Vanguard42Testimonials() {

        let testimonials = $('.Vanguard42-testimonials');
    ...
    function Vanguard42ScrollButtons() {

        let button = $('.Vanguard42-scroll-button')
    ...
    function Vanguard42NumberCounter() {

        let numberCt = $('.Vanguard42-number-counter');
    ...
    function Vanguard42TeamMember() {

        const member = $('.Vanguard42-team-member');
    ...
    function Vanguard42InfiniteTabs() {
        let Vanguard42InfiniteTab = $('.Vanguard42-infinite-tabs');

        Vanguard42InfiniteTab.each(function () {
            let $this = $(this),
    ...
    function initPages() {
        $('.project-page').length ? Vanguard42ProjectPages() : '';
        Vanguard42Portfolio();
        Vanguard42ProductPage();
        Vanguard42SinglePostPage()
    ...
    function initPageElements() {
        ...
        Vanguard42Icons()
        Vanguard42Heading()
        Vanguard42CartButton()
        Vanguard42TeamMember()
        Vanguard42CircleText();
        Vanguard42Buttons();
        Vanguard42Marquee()
        Vanguard42Services()
        Vanguard42NumberCounter();
        Vanguard42Accordion();
        Vanguard42InfiniteTabs();
        Vanguard42ClinetsCarousel();
        Vanguard42InfiniteCarousel();
        Vanguard42DynamicGrid();
        Vanguard42FilterableGrid();
        Vanguard42Forms();
        gridScroll()
        Vanguard42Testimonials()
        //                Vanguard42ImageCompare()

        Vanguard42DynamicCarousel();
        Vanguard42Parallax();
        Vanguard42Lightbox()
        Vanguard42DynamicList();
        detectPov()
        circleMaskBg();

        Vanguard42SingleProject();
    }
    ...
    $(window).on('load', function () {
        ...
        Vanguard42Video($('.Vanguard42-video'));
        Vanguard42GeneralAnims($('.has-anim'));
        Vanguard42TextAnims();
        Vanguard42TextWrapper();
        Vanguard42ListAnimations();
        Vanguard42ImageAnims()
        Vanguard42ParallaxImages();
    ...
    let transitions = $('.Vanguard42-page-transition'),
        ...
        transitions: [
            {
                ...
                beforeEnter(data) {
                    ...
                    return new Promise(function (resolve, reject) {
                        ...
                        let styleSheet = $(response).filter('style#Vanguard42-body-styles')[0];
                ...
                leave(trigger) {
                    ...
                    return new Promise(function (resolve, reject) {
                        ...
                        if (media.find('.Vanguard42-video').length) {
                ...
                leave() {
                    ...
                    return new Promise(function (resolve, reject) {
                        ...
                        let media = $('.next-project-image'),
                            parent = $('.Vanguard42-next-project'),
    ...
    barba.hooks.enter((data) => {
        ...
        var headTags = [
                                ...
                                'style[id*="Vanguard42-body-styles"]'
            ].join(',');
        $(response).remove();
        ...
        Vanguard42Smoother == true ? $('body').addClass('smooth-scroll') : '';
    ...
    barba.hooks.after((data) => {
        ...
        Vanguard42TextAnims();
        Vanguard42TextWrapper();
        Vanguard42GeneralAnims($('main .has-anim'));
        ...
        Vanguard42Sections();
        initPages();
        Vanguard42Video($('#primary').find('.Vanguard42-video'));

        ScrollTrigger.refresh(true);
        Vanguard42MouseCursor(false);
    ...
    $(document).ready(function () {
        ...
        $.getJSON('http://localhost/Vanguard42-last/package.json', function (jd) {
